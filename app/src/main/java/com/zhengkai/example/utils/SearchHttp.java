...
//        获取从服务器接受到的JSON串
            ...
            if (gsonResult != null) {
                try {
//                解析JSON
                    Type listType = new TypeToken<LinkedList<JSONBean>>() {
                    }.getType();
                ...
                /* 825 不知道有没有用
                chatMessage.setAnswer(String.valueOf(Html.fromHtml(users.get(0).getAnswer())));
                chatMessage.setAnswer2(String.valueOf(Html.fromHtml(users.get(1).getAnswer())));
                chatMessage.setAnswer3(String.valueOf(Html.fromHtml(users.get(2).getAnswer())));
                chatMessage.setAnswer4(String.valueOf(Html.fromHtml(users.get(3).getAnswer())));
                chatMessage.setAnswer5(String.valueOf(Html.fromHtml(users.get(4).getAnswer())));*/
